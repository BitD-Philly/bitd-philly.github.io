...
<center><img src="{{site.baseurl}}/assets/img/V-SEA-W_logo.png" alt="V-Sea-W logo, flanked by knives. the caption reads the schmeek shall inherit the earth." width=90 style="float:none;"></center>
...
The purpose of this website is to create a centralized place for the gang to be able to access important information quickly-- as a pocket reference to [characters](/wiki/npcs) and other [gangs](/wiki/factions), as well as keep track of some of the simulationist aspects of the game, as on the [gang page](/gang/).
